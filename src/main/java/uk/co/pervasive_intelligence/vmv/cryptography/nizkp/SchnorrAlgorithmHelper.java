...
/**
 * Schnorr NIZKP implementation of the {@link AlgorithmHelper}.
 *
 * @author Matthew Casey, Pervasive Intelligence Ltd
 */
public class SchnorrAlgorithmHelper extends ChaumPedersenAlgorithmHelper implements AlgorithmHelper {

  /** Logger. */
  private static final Logger LOG = LoggerFactory.getLogger(SchnorrAlgorithmHelper.class);
  ...
  public KeyPair createKeys(final SecureRandom random, final Parameters parameters) throws CryptographyException {
    throw new CryptographyException("Schnorr algorithm cannot be used to create keys");
  }
  ...
  public Parameters createParameters(final SecureRandom random, final Object... values) throws CryptographyException {
    throw new CryptographyException("Schnorr algorithm cannot be used to create parameters");
  }
  ...
  public byte[] decrypt(final Parameters parameters, final KeyPair keyPair, final byte[] data) throws CryptographyException {
    throw new CryptographyException("Schnorr algorithm cannot be used for encryption/decryption");
  }
  ...
  public Proof generateProof(final SecureRandom random, final Parameters parameters, final BigInteger witness, final Statement... statements) throws CryptographyException {
    // Make sure we have exactly one statement.
    if ((statements == null) || (statements.length != 1)) {
      throw new CryptographyException("Must have one statement");
    }

    return super.generateProof(random, parameters, witness, statements);
  }
  ...
  public byte[] sign(final Parameters parameters, final KeyPair keyPair, final byte[] data) throws CryptographyException {
    throw new CryptographyException("Schnorr algorithm cannot be used for sign/verify");
  }
  ...
  public boolean verifyProof(final Parameters parameters, final Proof proof, final Statement... statements) throws CryptographyException {
    ...
    return super.verifyProof(parameters, proof, statements);
  }
}
