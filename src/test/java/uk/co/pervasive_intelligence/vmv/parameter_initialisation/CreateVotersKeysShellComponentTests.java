...
public class CreateVotersKeysShellComponentTests extends BaseTestCase {
  ...
  public void testCreateVoters() throws Exception {
    ...
    final List<VoterKeyPairs> outputVotersParameters =
        (List<VoterKeyPairs>) createVotersKeysShellComponent.readCSV(this.outputVotersKeys, VoterKeyPairs.class);
    ...
    final List<VoterKeyPairs> publishVotersParameters =
        (List<VoterKeyPairs>) createVotersKeysShellComponent.readCSV(this.publishVotersKeys, VoterKeyPairs.class, JacksonViews.Public.class);
